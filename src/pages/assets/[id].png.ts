  ...
  return [
    ...
    })),
    {
      ...
      props: {
        ...
        date: null,
        description:
          "Software engineer, writer, open-source enthusiast," + " rock climber, and skier.",
      },
    },
  ];
}
...
export async function GET({ props }: APIContext<InferGetStaticPropsType<typeof getStaticPaths>>) {
